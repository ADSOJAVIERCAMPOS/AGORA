...
Route::middleware(['auth:sanctum', 'coordinador_admin'])->group(function () {
    // Rutas reales de gestión de auxiliares
    Route::get('/auxiliares', [AuxiliarController::class, 'index']);
    Route::post('/auxiliares', [AuxiliarController::class, 'store']);
    Route::get('/auxiliares/{id}', [AuxiliarController::class, 'show']);
    Route::put('/auxiliares/{id}', [AuxiliarController::class, 'update']);
    Route::delete('/auxiliares/{id}', [AuxiliarController::class, 'destroy']);
    Route::post('/auxiliares/{id}/activate', [AuxiliarController::class, 'activate']);
    Route::post('/auxiliares/{id}/deactivate', [AuxiliarController::class, 'deactivate']);

    // Rutas de gestión de usuarios (solo coordinador o admin)
