  ...
  return (
    <>
      <style jsx>{`
        ...
        .submit-button {
          width: 100%;
          background: linear-gradient(to right, #39A900, #39A900);
          color: #fff;
          padding: 1rem 2rem;
          font-weight: 700;
          font-size: 1.2rem;
        ...
        .submit-button:hover {
          background: linear-gradient(to right, #2e8600, #39A900);
        }
      ...
      <div className="login-bg">
        ...
        <div className="login-form-container">
          ...
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <span style={{ color: '#39A900', fontWeight: 'bold', fontSize: 40, letterSpacing: 4 }}>AGORA</span>
          </div>
          <div className="scene">
            <div className={`card ${currentView === 'login' ? 'is-login' : 'is-forgot-password'}`}>
              {/* Login */}
              <div className="card__face card__face--front">
                <h1 className="text-2xl font-bold mb-6" style={{ color: '#39A900' }}>
                  Iniciar Sesión
                </h1>
