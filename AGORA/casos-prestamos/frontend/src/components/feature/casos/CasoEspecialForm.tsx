  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: `Número de caso: ${result.data.numeroCaso}`,
        width: 600,
        padding: '3em',
        color: '#39A900',
      ...
      Swal.fire({
        title: 'Error',
        text: 'Error al crear el caso especial. Por favor, intente nuevamente.',
        width: 600,
        padding: '3em',
        color: '#b71c1c',
        background: '#fff',
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full max-w-xs mx-auto px-2 py-1.5 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#39A900]"
              rows={3}
            />
          </div>
        </div>
